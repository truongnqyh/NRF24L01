...
void NRF24_Init (void)
{
	...
	nrf24_WriteReg(CONFIG,0); //interrupt TX
...
uint8_t IsDataAvailable(int pipenum)
{
	...
	{
		nrf24_WriteReg(STATUS, (1<<6));// clear bit TX_DS
		return 1;
	}
	return 0;
}
